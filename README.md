# SCoNE
Code for SCoNE: a Self-Correcting and Noise-Augmented Method for Complex Biological and Chemical Named Entity Recognition
...
(Refer to Appendix D in the paper for more details.)
